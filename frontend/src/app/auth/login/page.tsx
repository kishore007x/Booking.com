      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
        ...
        <div className="p-8 pb-6 border-b border-slate-100 flex flex-col items-center">
          ...
          <p className="text-slate-500 text-sm mt-2 text-center">
            {isLogin ? "Enter your credentials to access your account" : "Sign up to start booking your dream stays"}
          </p>
        </div>
        ...
        <div className="p-8 pt-6 space-y-6">
          <div className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                {isLogin && <Link href="#" className="text-xs text-primary font-medium hover:underline">Forgot password?</Link>}
              </div>
              <div className="relative">
          ...
          <Button 
            className="w-full rounded-xl py-6 text-base font-bold shadow-lg shadow-primary/25"
          ...
          <div className="relative flex items-center justify-center">
            ...
            <span className="bg-white px-4 text-xs text-slate-500 uppercase font-semibold relative z-10">Or continue with</span>
          </div>
